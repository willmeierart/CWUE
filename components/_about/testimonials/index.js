...
export default class Testimonials extends Component {
	...
	render () {
		...
		const renderTestimonialList = testimonials.map((t, i) => <Testimonial key={i} left={i % 2 === 0} />)
		...
		return (
			<div className='outer-container'>
				<div className='inner-container'>
					...
					<div className='testimonial-list-wrapper'>{renderTestimonialList.slice(0, showVal)}</div>
					{showVal !== sliceEnd && (
